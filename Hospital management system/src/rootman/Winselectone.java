...
public class Winselectone {
	...
	private void initialize() {
		...
		comboBox.addItem("员工姓名");
		comboBox.addItem("职务");
		comboBox.addItem("性别");
		comboBox.addItem("所在部门号");
		...
		button.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent e)
			{
				...
				{
				//	System.out.println(content);
					String[][] data=Selectone.getage(content);
					table = new JTable(data,dataTitle);
					table.setFont(new Font("宋体", Font.PLAIN, 18));
					table.setRowHeight(25);
					scrollPane.setViewportView(table);
				...
				{
				//	System.out.println(content);
					String[][] data=Selectone.getsex(content);
					table = new JTable(data,dataTitle);
					table.setFont(new Font("宋体", Font.PLAIN, 18));
					table.setRowHeight(25);
					scrollPane.setViewportView(table);
				...
				{
				//	System.out.println(content);
					String[][] data=Selectone.getdepartments(content);
					table = new JTable(data,dataTitle);
					table.setFont(new Font("宋体", Font.PLAIN, 18));
					table.setRowHeight(25);
					scrollPane.setViewportView(table);
