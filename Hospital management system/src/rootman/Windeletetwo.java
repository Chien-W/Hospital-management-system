...
public class Windeletetwo {
	...
	public static void start() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Windeletetwo window = new Windeletetwo();
	...
	private void initialize() {
		...
		JLabel label = new JLabel("\u4F60\u9700\u8981\u5220\u9664\u7684\u5458\u5DE5\u5DE5\u8D44\u5458\u5DE5\u53F7\u4E3A\uFF1A");
		...
		String[][] data=Showtwo.getRows();
		String[] dataTitle =Showtwo.getHead();
