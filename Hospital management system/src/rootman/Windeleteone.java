...
public class Windeleteone {
	...
	public static void start() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Windeleteone window = new Windeleteone();
	...
	private void initialize() {
		...
		JLabel label = new JLabel("\u4F60\u9700\u8981\u5220\u9664\u7684\u5458\u5DE5\u53F7\u4E3A\uFF1A");
		...
		String[][] data=Showone.getRows();
		String[] dataTitle =Showone.getHead();
