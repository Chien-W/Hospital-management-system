...
public class Insertinpatient {
	...
	public static void start() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Insertinpatient window = new Insertinpatient();
	...
	private void initialize() {
		...
		JLabel label = new JLabel("\u4F60\u9700\u8981\u589E\u52A0\u7684\u75C5\u4EBA\u4FE1\u606F\u4E3A\uFF1A");
		...
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				Insert2.insert(Name, Sex, Time, Department, Condition, Doctor, Room, Bed);
				JOptionPane.showMessageDialog(frame, "入院成功!");
				frame.dispose();
			}
		});
		...
		groupLayout.setHorizontalGroup(
			groupLayout.createParallelGroup(Alignment.LEADING)
				.addGroup(groupLayout.createSequentialGroup()
					.addGap(18)
					.addComponent(label, GroupLayout.PREFERRED_SIZE, 279, GroupLayout.PREFERRED_SIZE)
